  ...
  return (
    <div className="flex justify-between items-center">
      <div className="flex items-center page-title">
        ...
        <p className="text-xl font-semibold">{pageName} ({user ? user.email : 'undefined'})</p>
      </div>
      ...
      <div className="flex items-center">
        ...
        <div className="px-2">
          <button className="w-[50px] h-[50px] bg-[url(https://i.pravatar.cc/70)] bg-center rounded-full transition-all hover:bg-white hover:shadow-md p-2" onClick={toggleProfile}></button>
        </div>
      </div>
    </div>
  );
